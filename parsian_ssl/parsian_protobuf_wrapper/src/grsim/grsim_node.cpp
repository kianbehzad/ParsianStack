...
void GrsimNode::command_callback(const parsian_msgs::msg::ParsianRobotCommand::SharedPtr msg)
{
...
void GrsimNode::worldmodel_callback(const parsian_msgs::msg::ParsianWorldModel::SharedPtr msg)
{
