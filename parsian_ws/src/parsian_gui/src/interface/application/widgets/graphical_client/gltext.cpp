...
rcsc::Vector2D GLText::getSize(char ch)
{
  return rcsc::Vector2D(getWidth(ch),getHeight(ch));
}
...
void GLText::drawString(rcsc::Vector2D loc, double angle, double size, const char* str, HAlignOptions hAlign, VAlignOptions vAlign)
{
