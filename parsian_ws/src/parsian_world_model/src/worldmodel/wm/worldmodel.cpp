...
void WorldModel::updateDetection(const parsian_msgs::msg::SSLVisionDetection::SharedPtr& _detection) {
...
parsian_msgs::msg::ParsianWorldModel::SharedPtr WorldModel::getParsianWorldModel() {
//    if (this->ball == nullptr) return rosWM;

    parsian_msgs::msg::ParsianWorldModel::SharedPtr rosWM{new parsian_msgs::msg::ParsianWorldModel};
...
void WorldModel::printRobotInfo(const parsian_msgs::msg::SSLVisionDetectionRobot &robot) {
...
void WorldModel::testFunc(const parsian_msgs::msg::SSLVisionDetection::SharedPtr &detection) {
    ...
    for (int i = 0; i < balls_n; i++) {
        parsian_msgs::msg::SSLVisionDetectionBall ball = detection->balls[i];
    ...
    for (int i = 0; i < robots_blue_n; i++) {
        parsian_msgs::msg::SSLVisionDetectionRobot robot = detection->us[i];
    ...
    for (int i = 0; i < robots_yellow_n; i++) {
        parsian_msgs::msg::SSLVisionDetectionRobot robot = detection->them[i];
