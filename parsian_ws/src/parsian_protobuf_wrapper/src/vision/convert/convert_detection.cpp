 ...
 */
    ...
    parsian_msgs::msg::SSLVisionDetection rosFrame;
    ...
    for (int i = 0; i < protoFrame.balls().size(); ++i) {
        ...
        parsian_msgs::msg::SSLVisionDetectionBall rosBall = convert_detection_ball(protoBall);
    ...
    for (int i = 0; i < protoFrame.robots_yellow().size(); ++i) {
        ...
        parsian_msgs::msg::SSLVisionDetectionRobot rosBot = convert_detection_robot(protoBot);
        if (isYellow) {
 ...
 */
    ...
    parsian_msgs::msg::SSLVisionDetectionBall rosBall;
 ...
 */
    ...
    parsian_msgs::msg::SSLVisionDetectionRobot rosBot;
