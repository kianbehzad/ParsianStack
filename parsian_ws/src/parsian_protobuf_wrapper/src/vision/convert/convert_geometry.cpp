 ...
 */
    parsian_msgs::msg::SSLVisionGeometry convert_geometry_data(SSL_GeometryData protoData) {
        parsian_msgs::msg::SSLVisionGeometry rosData;
        ...
        for (int i = 0; i < protoData.calib_size(); ++i) {
            ...
            parsian_msgs::msg::SSLVisionGeomCameracalibration rosCal = convert_geometry_camera_calibration(protoCal);
 ...
 */
    parsian_msgs::msg::SSLVisionGeomCameracalibration convert_geometry_camera_calibration(SSL_GeometryCameraCalibration protoCal) {
        parsian_msgs::msg::SSLVisionGeomCameracalibration rosCal;
 ...
 */
    parsian_msgs::msg::SSLVisionGeomField convert_geometry_field_size(SSL_GeometryFieldSize protoSize) {
        parsian_msgs::msg::SSLVisionGeomField rosSize;
        ...
        for (int i = 0; i < protoSize.field_lines_size(); ++i) {
            ...
            parsian_msgs::msg::SSLVisionGeomFieldLine rosLine = convert_geometry_field_line_segment(protoLine);
        ...
        for (int i = 0; i < protoSize.field_arcs_size(); ++i) {
            ...
            parsian_msgs::msg::SSLVisionGeomFieldArc rosArc = convert_geometry_field_Circular_arc(protoArc);
 ...
 */
    parsian_msgs::msg::SSLVisionGeomFieldLine convert_geometry_field_line_segment(SSL_FieldLineSegment protoLine) {
        parsian_msgs::msg::SSLVisionGeomFieldLine rosLine;
 ...
 */
    parsian_msgs::msg::SSLVisionGeomFieldArc convert_geometry_field_Circular_arc(SSL_FieldCicularArc protoArc) {
        ...
        parsian_msgs::msg::SSLVisionGeomFieldArc rosArc;
